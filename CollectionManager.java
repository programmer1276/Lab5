...
import Utility.UpdateCollection;
...
public class CollectionManager {
    ...
    public MusicBand getCollectionById(int id) throws NoSuchElementException {
        MusicBand mb = null;
    ...
    public static boolean removeById(Integer id) throws EmptyCollectionException {
        ...
        MusicBand musicBand = manager.getCollectionById(id);
        if(musicBand != null){
            manager.getPreviousIDs().remove(id);
